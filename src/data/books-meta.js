...
export const metaArray = [
  ...
  , {
    ...
    track: 'sales',
    relatedTracks: ['sales'],
    tags: ['优势谈判', '开局策略', '钳子策略', '谈判让步', '道森', '价格谈判', '条款博弈'],
    rating: 4.6,
    cover: '#B5462E',
    intro: '罗杰·道森把"谈判"从天赋拆成可练习的战术库。核心主张：绝不和对方的第一次开价说 yes、永远让对方先亮底、用"钳子"（"你还得更好些"）锁住让步节奏、用"更高权威"给自己留缓冲、终局再"咬一口"（nibble）多要一点。政企大单常卡在价格与条款，这本书补的是"价值讲完了、怎么把价谈回来"的临门一脚——全站此前谈判类 0 本，政企丢单高频痛点正落在这里。',
    meta: {
